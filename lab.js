...
function ingredients(obj){
  ...
  let {protien} = obj;
  let newArray =[]
newArray.push(carb, fat, protien)
return newArray
}
...
// let toby = new Cat('toby', 15, 'black')
...
let newWizard = new Wizard('Tanner', 94, 'arba kadabra')
...
let phone1 = new Phone('IPHONE', '11x', '110g', 'white', 99)
let phone2 = new Phone('iphone', '20x', '150g', 'yellow', 200)
let phone3 = new Phone('Android', '10x', '103g', 'black', 99)
